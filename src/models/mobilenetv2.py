...
class MobileNetV2(nn.Module):
    def __init__(self, num_classes=1000, sample_size=224, width_mult=1., quantize=False):
        ...
        for t, c, n, s in interverted_residual_setting:
            ...
            for i in range(n):
                ...
                self.features.append(
                    block(input_channel, output_channel, stride, expand_ratio=t, quantize=self.quantize))
